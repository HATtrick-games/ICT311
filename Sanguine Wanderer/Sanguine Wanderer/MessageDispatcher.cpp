...
boost::scoped_ptr<MessageDispatcher> MessageDispatcher::singleton(NULL);
...
{
	AIObject* pReceiver = (*AIObjectManager::GetInstance())->GetObjectFromID(receiver);
	...
	Telegram message(0.0, sender, receiver, msg, extraInfo);
...
boost::scoped_ptr<MessageDispatcher>* MessageDispatcher::GetInstance()
{
