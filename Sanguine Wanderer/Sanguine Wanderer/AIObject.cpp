...
void AIObject::InitialiseCollisionBody()
{
	...
	cbCollisionObject = new CollisionBody(MeshCenter,((ObjectMesh->GetMaxX()-ObjectMesh->GetMinX())*Scale.x)/2,3/*((ObjectMesh->GetMaxY()-ObjectMesh->GetMinY())*Scale.y)/2*/,((ObjectMesh->GetMaxZ()-ObjectMesh->GetMinZ())*Scale.z)/2, "move");
